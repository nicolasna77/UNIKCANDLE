          ...
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
            ...
            >
              <TabsList className="grid grid-cols-3 w-full lg:w-auto">
                <TabsTrigger value="all" disabled={isFetching}>Toutes</TabsTrigger>
                <TabsTrigger value="PROCESSING" disabled={isFetching}>En cours</TabsTrigger>
                <TabsTrigger value="DELIVERED" disabled={isFetching}>Livrées</TabsTrigger>
              </TabsList>
            </Tabs>
