    ...
    <section className="relative isolate min-h-screen flex items-center justify-center overflow-hidden ">
      ...
      >
        <div
          ...
          className="relative left-[calc(50%-11rem)] aspect-1155/678 w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-linear-to-tr from-secondary to-[#9089fc] opacity-30 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
        />
      </div>
